...
Java_com_cam_ndkotlin_ImageParser_parseImage(JNIEnv *env, jobject thiz) {
//    thiz->getStringField("name")
    LOGE("hello>>");
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_cam_ndkotlin_ImageParser_00024Companion_staticFun(JNIEnv *env, jobject thiz) {
...
Java_com_cam_ndkotlin_ImageProcess_add(JNIEnv *env, jobject thiz, jint a, jint b) {
    return add(a,b);
}